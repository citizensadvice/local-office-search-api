...
module ApiV2Schema
  ...
  TIME_RANGE_SET = { type: :array, items: TIME_RANGE }.freeze

  OPENING_HOURS = {
    type: :object,
    properties: {
      information: { type: NULLABLE_STRING },
      monday: { type: TIME_RANGE_SET },
      tuesday: { type: TIME_RANGE_SET },
      wednesday: { type: TIME_RANGE_SET },
      thursday: { type: TIME_RANGE_SET },
      friday: { type: TIME_RANGE_SET },
      saturday: { type: TIME_RANGE_SET },
      sunday: { type: TIME_RANGE_SET }
    },
